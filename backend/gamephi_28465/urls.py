"""gamephi_28465 URL Configuration
...
admin.site.site_header = "GamePhi"
admin.site.site_title = "GamePhi Admin Portal"
admin.site.index_title = "GamePhi Admin"

# swagger
api_info = openapi.Info(
    title="GamePhi API",
    default_version="v1",
    description="API documentation for GamePhi App",
)
